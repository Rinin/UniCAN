...
///////////////////////////////////////////////////////////////////////////////
/**
  ECI API function redefintions for IXXAT Interface: iPC-I XC16/PCIe.
...
#define ECIDRV_                     ECI10E_                   
#define ECIDRV_Initialize           ECI10E_Initialize         
#define ECIDRV_Release              ECI10E_Release            
#define ECIDRV_GetInfo              ECI10E_GetInfo            
#define ECIDRV_CtrlOpen             ECI10E_CtrlOpen           
#define ECIDRV_CtrlClose            ECI10E_CtrlClose          
#define ECIDRV_CtrlStart            ECI10E_CtrlStart          
#define ECIDRV_CtrlStop             ECI10E_CtrlStop           
#define ECIDRV_CtrlGetCapabilities  ECI10E_CtrlGetCapabilities
#define ECIDRV_CtrlGetStatus        ECI10E_CtrlGetStatus      
#define ECIDRV_CtrlSend             ECI10E_CtrlSend           
#define ECIDRV_CtrlReceive          ECI10E_CtrlReceive        
#define ECIDRV_CtrlSetAccFilter     ECI10E_CtrlSetAccFilter
#define ECIDRV_CtrlAddFilterIds     ECI10E_CtrlAddFilterIds
#define ECIDRV_CtrlRemFilterIds     ECI10E_CtrlRemFilterIds    
#define ECIDRV_CtrlCommand          ECI10E_CtrlCommand        
#define ECIDRV_LogConfig            ECI10E_LogConfig          
#define ECIDRV_LogRead              ECI10E_LogRead            
#define ECIDRV_LogStart             ECI10E_LogStart           
#define ECIDRV_LogStop              ECI10E_LogStop            
#define ECIDRV_LogClear             ECI10E_LogClear           
#define ECIDRV_GetErrorString       ECI10E_GetErrorString     
