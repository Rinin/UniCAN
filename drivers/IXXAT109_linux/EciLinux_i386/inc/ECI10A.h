...
#define ECIDRV_CtrlSetAccFilter     ECI10A_CtrlSetAccFilter
#define ECIDRV_CtrlAddFilterIds     ECI10A_CtrlAddFilterIds
#define ECIDRV_CtrlRemFilterIds     ECI10A_CtrlRemFilterIds   
