...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT ECI_HANDLE ECI_APICALL OS_CreateEvent ( void );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT DWORD ECI_APICALL OS_SetEvent ( ECI_HANDLE hEvent );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT DWORD ECI_APICALL OS_WaitForSingleObject ( ECI_HANDLE hEvent,
                                                         DWORD  dwTimeout );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT ECI_HANDLE ECI_APICALL OS_CreateMutex ( void );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT DWORD ECI_APICALL OS_LockMutex ( ECI_HANDLE hMutex );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT DWORD ECI_APICALL OS_UnlockMutex ( ECI_HANDLE hMutex );
...
/**
  ...
  @ingroup OsEci
*/
ECI_DLLEXPORT DWORD ECI_APICALL OS_CloseHandle ( ECI_HANDLE hHandle );
