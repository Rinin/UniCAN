...
#define ECIDRV_CtrlSetAccFilter     ECI111_CtrlSetAccFilter
#define ECIDRV_CtrlAddFilterIds     ECI111_CtrlAddFilterIds
#define ECIDRV_CtrlRemFilterIds     ECI111_CtrlRemFilterIds        
